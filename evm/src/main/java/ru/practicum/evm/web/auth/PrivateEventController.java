package ru.practicum.evm.web.auth;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.web.bind.annotation.*;
import ru.practicum.evm.model.event.EventFullDto;
import ru.practicum.evm.model.event.EventShortDto;
import ru.practicum.evm.model.event.EventUpdateDto;
import ru.practicum.evm.model.event.NewEventDto;
import ru.practicum.evm.model.request.ParticipationRequestDto;
import ru.practicum.evm.service.event.EventService;
import ru.practicum.evm.service.request.RequestService;
